                    ...
                    <div class="inner-box">
                        ...
                        <h4 class="title-2">
                            <strong>
                                ...
                                @endif
                                <span class="small badge badge-success"> Rs.{{ $selectedPackage->price }}</span>
                            </strong>
                        </h4>
                                ...
                                <form class="form" id="postForm" method="POST" action="{{ url()->current() }}">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="text-center">
                                            <h2>Scan To Pay on Google Pay Here !</h2>
                                            <br>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12 text-center mt-4">
                                                ...
                                                <a href="{{ route('Payumoney.view', ['price' => $selectedPackage->price, 'packageId' => Request::get('package')]) }}"
                                                    class="btn btn-success btn-lg submitPostForm">Pay Now</a>
                                            </div>
                                        </div>
